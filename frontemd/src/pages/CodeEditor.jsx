...
//     socket.on("user-left", (data) => setParticipants(data.participants));
...
//     setLanguage(newLang);
//     socketRef.current.emit("code-change", roomId, user.id, code, newLang);
//   };
...
//           <div>
//             <h1 className="text-xl font-bold">CodeRoom</h1>
